...
test_dataset = Dataset('test_images/', df_test, transform=test_transforms, t_mode = 'test')
...
with torch.no_grad():
    ...
    for (img_batch, _) in tqdm(data.DataLoader(test_dataset, batch_size = BATCH_SIZE, shuffle = False,
